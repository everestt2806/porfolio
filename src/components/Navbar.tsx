      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-text-secondary hover:text-secondary transition-colors relative group"
              >
                {link.label}
                <motion.span
          ...
          <button
            ...
            className="md:hidden text-text-secondary hover:text-secondary transition-colors"
          >
            <svg
              className="w-6 h-6"
              fill="none"
              ...
              <div className="flex flex-col space-y-4">
                {navLinks.map((link) => (
                  <Link
                    ...
                    className="text-text-secondary hover:text-secondary transition-colors py-2"
                  >
                    {link.label}
                  </Link>
                ))}
